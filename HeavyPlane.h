...
//
// REMARKS: This file contains the declaration of the HeavyPlane class. The HeavyPlane class is a subclass of the Plane class and is used to represent the heavy planes in the simulation. The class contains the wake time of the plane. The class also contains a constructor with parameters, a method to get the wake time of the plane
//
//-----------------------------------------
#pragma once
#include "Plane.h"
...
class HeavyPlane : public Plane
{
    ...
    public:
        HeavyPlane();
        HeavyPlane(string,int,string,int);
